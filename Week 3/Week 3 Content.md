...
3. [Problem Solving Approaches](#Problem-Solving-Approaches)
   ...
   * [Guide to use each of the two Problem-solving Framework](#Guide-to-use-each-of-the-two-problem-solving-framework)
...
### 5 Ws (+H) Technique
This is also a helpful approach to better understand, define, and articulate a problem is the 5 Ws (+H): What, Who, Where, When, Why, (and How).
...
These two framework are approaches to problem-solving and decision-making. While they share some similarities, they differ in focus and application.
...
|Altematlves |	Dlstlnct, doable	|	Creatlve, Interesting|
|Information	| Reliable, relavant	|	Exploratory, moving |
|Values	| Preferences, metncs, tradeoffs	|	Intrinsic purpose |
|Integratlon	| Compelling loglC / reasoning	|	Insplnng narrative, community |
|Commltment to action	| Action  plans	|	Leadership, followshlP |
...
### Guide to use each of the two problem-solving framework
